...
public class PostSnippetTest {
    ...
    public void testPost00() {
        ...
        String str = CodeGenerator.createPostSnippet("testPost00","rx.Observable", "http://www.baidu.com",
    ...
    public void testPost01() {
        ...
        String str = CodeGenerator.createPostSnippet("testPost01","rx.Observable", "http://www.baidu.com",
                customParams, defaultParams, Object.class.getName());
    ...
    public void testPost02() {
        ...
        String sb = CodeGenerator.createPostSnippet("testPost02", "rx.Observable","http://www.baidu.com",
                customParams, defaultParams, Object.class.getName());
    ...
    public void testPost10() {
        ...
        String str = CodeGenerator.createPostSnippet("testPost10","rx.Observable", "http://www.baidu.com",
                customParams, defaultParams, Object.class.getName());
    ...
    public void testPost20() {
        ...
        String str = CodeGenerator.createPostSnippet("testPost20","rx.Observable", "http://www.baidu.com",
                customParams, defaultParams, Object.class.getName());
    ...
    public void testPost11() {
        ...
        String str = CodeGenerator.createPostSnippet("testPost11","rx.Observable", "http://www.baidu.com",
                customParams, defaultParams, Object.class.getName());
